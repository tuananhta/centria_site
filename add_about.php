<?php
session_start();
define('TITLE', 'Add about');
require 'header.php';
print '<h1 class="background_title3">ADD ABOUT</h1>';

/* This script adds a about content to the database. It now does so sercurely! */
...
if (isset($_POST['submitted'])) {
    ...
    if (!$problem) {
        $query = "INSERT INTO about VALUES (0, '$title', '$context', NOW(), '$pic')";
        // Execute the query
        if (@mysql_query($query)) {
            print '<h3>The about content has been added!</h3>';
...
print '
        <h2>Hello <i>'.$user_name.'</i>, please fill the form to add the about:</h2>
        <form enctype="multipart/form-data" action="add_about.php" method="POST">
            <table>
                <tr>
                    <td><h3>About Title: </h3></td>
