<?php
session_start();
define('TITLE', 'Add R&D');
require 'header.php';
print '<h1 class="background_title">ADD R&D</h1>';

/* This script adds a r&d content to the database. It now does so sercurely! */
...
if (isset($_POST['submitted'])) {
    ...
    if (!$problem) {
        $query = "INSERT INTO r_and_d VALUES (0, '$title', '$context', NOW(), '$pic')";
        // Execute the query
        if (@mysql_query($query)) {
            print '<h3>The r&d content has been added!</h3>';
...
// Display the form:   
    ...
    // Check the user permission
        ...
        print '
        <h2>Hello <i>'.$user_name.'</i>, please fill the form to add the r&d:</h2>
        <form enctype="multipart/form-data" action="add_r&d.php" method="POST">
            <table>
                <tr>
                    <td><h3>r&d Title: </h3></td>
