<?php
session_start();
define('TITLE', 'Add news');
require 'header.php';
print '<h1 class="background_title">ADD NEWS</h1>';

/* This script adds a news content to the database. It now does so sercurely! */
...
if (isset($_POST['submitted'])) {
    ...
    if (!$problem) {
        $query = "INSERT INTO news VALUES (0, '$title', '$context', NOW(), '$pic')";
        // Execute the query
        if (@mysql_query($query)) {
            print '<h3>The news content has been added!</h3>';
...
// Display the form:   
    ...
    // Check the user permission
        ...
        print '
        <h2>Hello <i>'.$user_name.'</i>, please fill the form to add the news:</h2>
