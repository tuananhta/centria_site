        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="width:25%; padding-right:10px; vertical-align:top;">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td class="background_title2" style="font-size:20px; font-weight:600;padding-left:15px; padding-top:7px; padding-bottom:7px;">ABOUT</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                while($row = mysql_fetch_array($r)){
                                    print '<a class="link2" href="about.php?id='.$row['id'].'"><b>></b> '.$row['title'].' </a><br />';
                                }
                                ?>
                            </td>
                        </tr>
