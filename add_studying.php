<?php
session_start();
define('TITLE', 'Add studying');
require 'header.php';
print '<h1 class="background_title2">ADD STUDYING</h1>';

/* This script adds a studying content to the database. It now does so sercurely! */
...
if (isset($_POST['submitted'])) {
    ...
    if (!$problem) {
        $query = "INSERT INTO studying VALUES (0, '$title', '$context', NOW(), '$pic')";
        // Execute the query
        if (@mysql_query($query)) {
            print '<h3>The studying content has been added!</h3>';
...
// Display the form:   
    ...
    // Check the user permission
        ...
        print '
        <h2>Hello <i>'.$user_name.'</i>, please fill the form to add the studying:</h2>
        <form enctype="multipart/form-data" action="add_studying.php" method="POST">
            <table>
                <tr>
                    <td><h3>Studying Title: </h3></td>
