        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="width:25%; padding-right:10px; vertical-align:top;">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td class="background_title2" style="font-size:20px; font-weight:600;padding-left:15px; padding-top:7px; padding-bottom:7px;">STUDYING</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                while($row = mysql_fetch_array($r)){
                                    print '<a class="link2" href="studying.php?id='.$row['id'].'"><b>></b> '.$row['title'].' </a><br />';
                                }
                                ?>
                            </td>
                        </tr>
                ...
                <td style="width: 50%; border-left: solid 2px #808080; border-right: solid 2px #808080; vertical-align:0px; padding-left:10px; padding-right:10px;">
                    ...
                    <table style="width:100%;">
                        <?php
                        $id = $_GET['id'];
                        $query = "SELECT * FROM studying WHERE id={$id}";
                        $r = mysql_query($query);
